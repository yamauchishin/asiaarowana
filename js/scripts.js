...
$(function() {
	...
	if ($('body').attr('class') === 'home') {
		...
		// show news section
		if (!$('#navNews').hasClass('nolink')) {
			$('#navNews').click(function() {
				$('#news').css('cssText', 'visibility: visible !important').css('z-index', 1).stop().fadeTo(1000, 1);
				$('nav ul, aside').css({
					opacity: 1,
					visibility: "hidden"
				}).animate({
		...
		if (!$('#navDesigner').hasClass('nolink')) {
			$('#navDesigner').click(function() {
				$('#designer').css('cssText', 'visibility: visible !important').css('z-index', 1).stop().fadeTo(1000, 1);
				$('nav ul, aside').css({
					opacity: 1,
					visibility: "hidden"
				}).animate({
		...
		// show archives section
		if (!$('#navArchives').hasClass('nolink')) {
			$('#navArchives').click(function() {
				$('#archives').css('cssText', 'visibility: visible !important').css('z-index', 1).stop().fadeTo(1000, 1);
				$('nav ul, aside').css({
					opacity: 1,
					visibility: "hidden"
				}).animate({
		...
		$(function() {
			...
			// $('#designer, .rsContent, .rsImg').css('cssText', 'visibility: visible !important').css('z-index', 1).stop().fadeTo(1000, 1);
